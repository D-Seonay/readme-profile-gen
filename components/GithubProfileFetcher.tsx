...
export const GithubProfileFetcher = () => {
  ...
  return (
    <div className="space-y-4 p-5 bg-zinc-900/80 border border-zinc-100/10 rounded-2xl shadow-xl backdrop-blur-xl animate-in fade-in slide-in-from-top-4 duration-700">
      ...
      <p className="text-[9px] font-mono text-zinc-600 italic">
        * Récupère automatiquement ton nom, ta bio et tes liens publics.
      </p>
    </div>
  );
};
